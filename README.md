...
- [ ] What problem does the context API help solve?
      A)  it allows  us to share specific forms of data across all levels of the application without prop drilling 
- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
      A) Actions are payloads of info that send data from your application to your store
      A)  Store holds  the whole state of the app in an immutable object tree
      A) The reducer is a pure function that takes the previous state and an action, and returns the next state.
      A) 'single source of truth' means that the only way to change your data in UI is to dispatch redux action which will change state within redux reducer
...
- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
    A) Context API because I used it to make this App : ^)
